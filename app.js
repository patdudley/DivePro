...
const fishTargets = [
  ...
  { name: "Bonito", habitat: "Current edges", prize: 66, abundance: 30, months: [7, 8, 9, 10], tempMin: 63, note: "fast pelagic", photo: 4, sizeRule: "Special size and bag provisions apply.", takeNote: "Use the current CDFW table before taking." },
